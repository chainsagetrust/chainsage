 ...
 * Design tokens only — verdict logic lives in the SDK / @chainsage/engine.
 */
...
/** Sacred verdict → color mapping (ALLOW=trust, REVIEW=warning, DENY=danger). */
export const verdictColor: Record<"ALLOW" | "REVIEW" | "DENY", string> = {
