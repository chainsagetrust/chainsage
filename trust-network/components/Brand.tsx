/**
 * Brand.tsx — the Sage Mark (inlined from brand/assets/sage-mark.svg) plus a
 * cohesive stroke icon set. All icons are 1.5–2px stroke, currentColor, so they
 * inherit text color and verdict tints naturally.
 */
...
export const Refresh = (p: IconProps) => (
  <Icon {...p}>
    <path d="M20 8a8 8 0 0 0-14.5-2.5M4 5v4h4" />
    <path d="M4 16a8 8 0 0 0 14.5 2.5M20 19v-4h-4" />
  </Icon>
);
